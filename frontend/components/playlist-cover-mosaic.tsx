...
// object-cover cannot trim. Over-zooming inside each tile's own
// overflow-hidden boundary pushes the crop past the bars.
const THUMBNAIL_ZOOM_CLASSES = "scale-[1.6]";
