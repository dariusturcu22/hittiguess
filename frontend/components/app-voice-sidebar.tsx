...
const SLIM_RAIL_PATH_PATTERN = /^\/(groups|sessions)\/\d+/;
const SLIM_RAIL_CLASSES = "flex w-[76px] shrink-0 flex-col items-center border-l-[3px] border-sidebar-border bg-sidebar py-5";
...
export function AppVoiceSidebar() {
  ...
  const showsSlimRail = SLIM_RAIL_PATH_PATTERN.test(pathname);
