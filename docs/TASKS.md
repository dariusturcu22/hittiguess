...
- [ ] Refresh active group membership after group creation, departure, and game-session changes
- [ ] Keep administrator controls loading-safe and make realtime status visually distinct from controls
- [ ] Improve chat input spacing and replace the native playlist picker with keyboard-accessible playlist choices
- [ ] Run frontend checks

Tests:

- [ ] Add or update focused realtime and lobby component coverage
