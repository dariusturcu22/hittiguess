...
3. A 3-5 second countdown follows lock-in, giving other players a moment to get ready to bet.
...
5. The song is revealed: artist, title, and year.
6. Scoring:
...
7. Next round: the active player role passes to the next player. The DJ role stays fixed or rotates, per the group setting.
