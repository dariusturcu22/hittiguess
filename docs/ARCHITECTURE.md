...
Hosting migration (story 7), database migration (story 8), DJ link-out playback flow (story 9), voice chat (story 12), group-scoped text chat (story 13), community reporting and confirmation flow (story 17), verified-promotion criteria (story 18), parallelized metadata pipeline fetches (story 24), cached metadata pipeline results (story 26), the UI redesign's implementation phase (story 28, design phase itself is done), difficulty-tuned game session generation (story 30), first-party usage analytics (story 34), public ground-truth data API (story 35), catalog seeding queue and bulk import (story 40), submission content safety (story 41), playlist-to-playlist song import (story 45), naming consistency (story 49), comment cleanup (story 48), test coverage (story 22).
