...
// SETTINGS_CHANGED routes to the settings topic, VOICE_PRESENCE_CHANGED routes to the
// voice topic, every other type routes to the membership topic, see
// GroupBroadcastListener.
